" Vim color scheme modified by AIR from Lucid
" ----------------------------------------------------------------------
"
" Repository: (original) https://github.com/cseelus/vim-colors-lucid
" Author:     AIR (original) Chris Seelus (@cseelus)
"
" BLACK
...
let colorgroup['ColorColumn']  = {"GUIFG": _gray_light, "GUIBG":  _rock}
...
let colorgroup['Folded']       = {"GUIFG": _cloud,     "GUIBG":  _rock,   "CTERM":"bold"}
...
let colorgroup['ModeMsg']      = {"GUIFG": _cyan, "CTERM":"bold"}
let colorgroup['Pmenu']        = {"GUIFG": _cloud,     "GUIBG":  _rock_medium}
let colorgroup['PmenuSel']     = {"GUIFG": _rock_dark, "GUIBG":  _gray_light}
...
let colorgroup['WildMenu'] = {"GUIFG": _rock, "GUIBG":  _cyan}
