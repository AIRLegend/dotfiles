" vim:fdm=marker
" Vim Color File
" Name:       onedark-air.vim
" Maintainer: AIRLegend
" License:    The MIT License (MIT)
" Based On:   https://github.com/joshdick/onedark.vim
" Note: Light modifications added for better visualization (IMO)
...
call s:h("TabLine", { "fg": s:visual_black, "bg": s:gutter_fg_grey}) " tab pages line, not active tab page label
call s:h("TabLineFill", {"bg": s:gutter_fg_grey}) " tab pages line, where there are no labels
